...
func main() {
	...
	u, err := launcher.New().Headless(false).UserDataDir("/Users/dkg/Library/Application Support/Google/Chrome/Default/").RemoteDebuggingPort(0).Delete("enable-automation").Bin("/Applications/Google Chrome.app/Contents/MacOS/Google Chrome").Launch()
	if err != nil {
		fmt.Println(err)
	}
